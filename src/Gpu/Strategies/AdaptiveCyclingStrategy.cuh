...
#ifndef ADAPTIVECYCLINGSTRATEGY_CUH
#define ADAPTIVECYCLINGSTRATEGY_CUH
...
namespace GPU{
    class AdaptiveCyclingStrategy;
}

class GPU::AdaptiveCyclingStrategy : public GPU::IStrategy {
...
#endif /* ADAPTIVECYCLINGSTRATEGY_CUH */

...
static __host__ __device__ double
...
gsl_cdf_ugaussian_P_ (const double x)
{
    double result;
    double absx = fabs (x);
...
__host__ __device__ double
gsl_cdf_ugaussian_Q_ (const double x)
{
    double result;
    double absx = fabs (x);
...
__host__ __device__ double
gsl_cdf_gaussian_P_ (const double x, const double sigma)
{
    return gsl_cdf_ugaussian_P_ (x / sigma);
}

__host__ __device__ double
gsl_cdf_gaussian_Q_ (const double x, const double sigma)
{
    return gsl_cdf_ugaussian_Q_ (x / sigma);
}
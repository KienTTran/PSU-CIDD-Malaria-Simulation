...
void GPU::TACTReporter::initialize() {}

void GPU::TACTReporter::before_run() {
...
void GPU::TACTReporter::monthly_report() {
...
void GPU::TACTReporter::after_run() {
  ss.str("");
  for (auto loc = 0; loc < Model::CONFIG->number_of_locations(); ++loc) {
...
void GPU::TACTReporter::begin_time_step() {}

void GPU::TACTReporter::output_genotype_frequency_3(const int& number_of_genotypes, GPU::PersonIndexByLocationStateAgeClass* pi) {
  auto sum1_all = 0.0;

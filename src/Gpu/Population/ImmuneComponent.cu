...
GPU::ImmuneComponent::ImmuneComponent(GPU::ImmuneSystem *immune_system) : immune_system_(immune_system), latest_value_(0.0) {}

GPU::ImmuneComponent::~ImmuneComponent() {
  immune_system_ = nullptr;
}

double GPU::ImmuneComponent::get_current_value(ImmuneSystemInformation h_immune_system_information,int latest_update_time,int current_time) {
  auto temp = 0.0;
...
void GPU::ImmuneComponent::update(ImmuneSystemInformation h_immune_system_information,int latest_update_time,int current_time) {
 ...
 * */
void GPU::ImmuneComponent::draw_random_immune(double value) {
